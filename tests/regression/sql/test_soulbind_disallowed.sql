...
CALL insert_nft_soulbind_op(block_num=>5, auth=>'bob', symbol=>'alice/ABC', ids=>ARRAY[1], soulbound=>TRUE);
CALL insert_nft_soulbind_op(block_num=>6, auth=>'charlie', symbol=>'alice/ABC', ids=>ARRAY[1], soulbound=>TRUE);
