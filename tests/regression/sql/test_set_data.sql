...
CALL insert_nft_set_data_op(block_num=>3, auth=>'alice', symbol=>'alice/XYZ', ids=>ARRAY[expected_instance_id(2,0,1)], data=>'{"key1": "value1"}'::jsonb);
CALL insert_nft_set_data_op(block_num=>4, auth=>'alice', symbol=>'alice/XYZ', ids=>ARRAY[expected_instance_id(2,0,1)], data=>'{"key2": "value2"}'::jsonb);
