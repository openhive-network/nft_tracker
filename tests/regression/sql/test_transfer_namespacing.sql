-- Check that transfer respects namespacing
...
CALL insert_nft_transfer_op(block_num=>3, pos=>1, auth=>'alice', symbol=>'alice/ABC', ids=>ARRAY[expected_instance_id(2,1,1)], to_account=>'bob');
