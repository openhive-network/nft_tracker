...
CALL insert_nft_transfer_op(block_num=>3, auth=>'alice', symbol=>'alice/XYZ', ids=>ARRAY[expected_instance_id(2,0,1)], to_account=>'bob');
CALL insert_nft_transfer_op(block_num=>4, auth=>'alice', symbol=>'alice/XYZ', ids=>ARRAY[expected_instance_id(2,0,1)], to_account=>'charlie');
