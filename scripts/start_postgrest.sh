...
POSTGRES_ACCESS=${POSTGRES_URL:-"postgresql://$POSTGRES_USER@$POSTGRES_HOST:$POSTGRES_PORT/$DB_NAME"}
...
start_webserver() {
    ...
    export PGRST_DB_SCHEMAS="nfttracker_endpoints"
    export PGRST_DB_ANON_ROLE="nfttracker_user"
